...
if ( $_GET[ 'form' ] == 'true' ) {
    ...
    foreach ( $result as $print ) {
        ...
        <option value = 'Regular Cab'<?php echo ( $selectedCity == 'Regular Cab' ) ? 'selected' : '';
        ?>>Regular Cab</option>
        <option value = 'Extended Cab' <?php echo ( $selectedCity == 'Extended Cab' ) ? 'selected' : '';
        ?>>Extended Cab</option>
        <option value = 'Crew Cab' <?php echo ( $selectedCity == 'Crew Cab' ) ? 'selected' : '';
        ?>>Crew Cab</option>
        </select>
        </div>
        <div class = 'form-group'>
        ...
        <div class = 'form-group'>
        <label>Message</label>
        <textarea class = 'form-control' rows = '3' name = 'message' id = 'message'><?php echo $print->message;
        ?></textarea>
        </div>
    ...
    <?php } else {
        ...
        <?php foreach ( $result as $var ) {
            ...
            <td>
            <a href = "admin.php?page=cab-booking&id=<?php echo $var->id; ?>&form=true">
